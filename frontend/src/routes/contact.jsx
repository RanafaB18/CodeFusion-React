                ...
                <section className="relative mb-56">
                    ...
                    <div className="text-gray-600 absolute -bottom-full w-full left-0 right-0 mx-auto">
                        <div className="bg-white max-w-md mx-auto flex flex-col border rounded-lg shadow-sm">
                            <button className="hover:text-orangish  cursor-pointer flex py-5 border rounded-tl rounded-tr justify-evenly border-l-2 border-l-orangish">
                                <svg className="w-6 h-auto opacity-75"
                                    width={20}
                                    aria-hidden="true"
