...
const icons = [
  ...
  {id: 5, icon: <svg fill="#d2d4d9" width="24" height="24" viewBox="0 0 24 24" name="tab" size="24" class="icon"><path d="M21,3H3A2,2 0 0,0 1,5V19A2,2 0 0,0 3,21H21A2,2 0 0,0 23,19V5A2,2 0 0,0 21,3M21,19H3V5H13V9H21V19Z"></path></svg>},
]
